...
На вход программа получает 6 натуральных чисел. X - расстояние между домино, далее вводятся значения длин домино. 
...
Количество упавших домино, 1 натуральное число, обозначим за n. 
